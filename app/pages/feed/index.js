define(function (require) {
    var Super = require('views/page'),
        Collection = require('collections/feed'),
    ...
    Page.prototype.render = function () {
        ...
        events['click #' + this.getId('list') + ' .feed'] = 'feedClickHandler';
        this.delegateEvents(events);

        this.ready();
    };

    Page.prototype.feedClickHandler = function (event) {
        ...
        return Promise.resolve(
            ...
            .finally(function () {
                         ...
                         if (this.collection.length < length + this.perPage) {
                             ...
                             this.controls.loadMore.attr('disabled', 'disabled');
                             this.controls.loadMore.text('No more item to load.');
                         }
                     }.bind(this));
    };
